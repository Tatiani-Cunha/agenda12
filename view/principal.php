        ...
        <input class="w3-input w3-border w3-round-large" name="txtID" type="hidden"
            ...
            <div class="w3-row w3-section">
                ...
                <div class="w3-rest">
                    ...
                    value="<?php echo (isset($_SESSION['Usuario']) && unserialize($_SESSION['Usuario'])) ? unserialize($_SESSION['Usuario'])->getNome() : '';?>">
                </div>
            </div>
            ...
            <div class="w3-row w3-section">
                ...
                <div class="w3-rest">
                    ...
                    value="<?php echo (isset($_SESSION['Usuario']) && unserialize($_SESSION['Usuario'])) ? unserialize($_SESSION['Usuario'])->getDataNascimento() : '';?>">
                </div>
            </div>
            <div class="w3-row w3-section">
                <div class="w3-col" style="width:11%;">
                ...
                <div class="w3-rest">
                    ...
                    value="<?php echo (isset($_SESSION['Usuario']) && unserialize($_SESSION['Usuario'])) ? unserialize($_SESSION['Usuario'])->getCPF() : '';?>">
                </div>
            </div>
            <div class="w3-row w3-section">
                <div class="w3-col" style="width:11%;">
                ...
                <div class="w3-rest">
                    ...
                    value="<?php echo (isset($_SESSION['Usuario']) && unserialize($_SESSION['Usuario'])) ? unserialize($_SESSION['Usuario'])->getEmail() : '';?>">
                </div>
            </div>
        ...
        <div class="w3-container">
            ...
            <thead>
                ...
                <?php
                    ...
                    if(isset($_SESSION['Usuario']) && unserialize($_SESSION['Usuario'])) {
