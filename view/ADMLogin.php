...
<form action="../Controller/Navegacao.php" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin w3-display-middle" style="width: 30%;">
    ...
    <h2 class="w3-center w3-text-cyan">Administrador</h2>
 	<div class="w3-row w3-section">
	<div class="w3-col" style="width:11%"><i class="w3-xxlarge fa fa-user w3-text-white"></i></div>
		<div class="w3-rest">
		<input class="w3-input w3-border w3-round-large" name="txtLoginADM" type="text" placeholder="Login CPF (ex.: 33333333333)">
		</div>
	</div>
	<div class="w3-row w3-section">
	<div class="w3-col" style="width:11%"><i class="w3-xxlarge fa fa-lock w3-text-white"></i></div>
		<div class="w3-rest">
	...
	<div class="w3-row w3-section">
		<div class="">
			<button name="btnLoginADM" class="w3-button w3-block w3-margin w3-cyan w3-cell w3-round-large" style="width: 90%;">Entrar</button>
		</div>
	</div>
</form>
</body>
